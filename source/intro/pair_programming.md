...
# Сарадња на решавању задатка - Пар програмирaње у учионици

У ИТ компанијама данас, агилна методологија (енгл. agile) је једна од најпопуларнијих и најраспрострањенијих метода развоја софтвера — посебно тамо где тимови треба брзо, заједнички и прилагодљиво да испоруче функционалан софтвер. **Пар програмирaње** (енгл. pair programming) је основна пракса у Extreme Programming (XP), која је једна од Agile методологија.

То је техника тимског развоја софтвера у којој два програмера раде заједно за једним рачунаром. Један програмер, који се зове **возач** (енгл. driver), пише код и фокусира се на синтаксу, док други, **навигатор** (енгл. navigator), прегледа сваки ред кода док се куца, тражи грешке, поставља питања и предлаже побољшања. Програмери често мењају улоге.
...
```{infonote} 
Да бисте успешно савладали ову лекцију биће потребно да радите у пару!
```

## Исходи и време реализације
...
```{learnmorenote} За наставнике

## Предности рада у пару за ученике
...
Наставници треба да опбрате пажњу на следеће могуће изазове при примени пар програмирања!
